...
const alertes: Alerte[] = [
  {
    id: "1",
    title: "M-04 Broyeur",
    motorId: "MTR-Broyeur-04",
    time: "Il y a 10 min",
    description: "Vibration RMS Critique (14.2 mm/s) détectée sur l'axe Z.",
    iconType: "critical",
  },
  {
    id: "2",
    title: "M-12 Convoyeur",
    motorId: "MTR-Ventil-12",
    time: "Il y a 45 min",
    description: "Désalignement détecté par modèle ML (Score: 0.89).",
    iconType: "warning",
  },
  {
    id: "3",
    title: "M-08 Pompe Principale",
    motorId: "MTR-Pompe-08",
    time: "Il y a 2h",
    description: "Température carcasse anormale (78°C).",
    iconType: "temp",
  },
];
