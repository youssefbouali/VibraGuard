          ...
          <>
            ...
            <div className="relative flex items-center justify-center w-44 h-44">
              <svg width="180" height="180" viewBox="0 0 180 180" fill="none">
                {/* Background circle (Correctif) */}
                <circle cx="90" cy="90" r="72" stroke={correctif?.color || "#0C6CF2"} strokeWidth="25.2" fill="none" />
                {/* Foreground arc (Préventif) */}
                <path
              ...
              <div className="absolute inset-0 flex flex-col items-center justify-center">
                <span className="text-[#E6F0F2] text-4xl font-bold">{preventifPct}%</span>
            ...
            <div className="flex items-center justify-center gap-8">
              {interventions.map(i => (
                <div key={i.type} className="flex items-center gap-2">
                  ...
                  <span className="text-[#C9E7E6] text-[13px] font-medium">{i.type}</span>
                </div>
              ))}
            </div>
          </>
