...
export function TraceabilityGraph() {
  const { data: steps = [], isLoading } = useTraceability();
  ...
  const getIcon = (type: string) => {
    switch (type) {
      ...
      case "order":
        return (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M7.50008 1.66699H12.5001C12.9603 1.66699 13.3334 2.04009 13.3334 2.50033V4.16699C13.3334 4.62723 12.9603 5.00033 12.5001 5.00033H7.50008C7.03984 5.00033 6.66675 4.62723 6.66675 4.16699V2.50033C6.66675 2.04009 7.03984 1.66699 7.50008 1.66699V1.66699" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M13.3335 3.33398H15.0002C15.9206 3.33398 16.6668 4.08018 16.6668 5.00065V16.6673C16.6668 17.5878 15.9206 18.334 15.0002 18.334H5.00016C4.07969 18.334 3.3335 17.5878 3.3335 16.6673V5.00065C3.3335 4.08018 4.07969 3.33398 5.00016 3.33398H6.66683M10.0002 9.16732H13.3335M10.0002 13.334H13.3335M6.66683 9.16732H6.67516M6.66683 13.334H6.67516" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      case "intervention":
        return (
      ...
      case "contract":
        return (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M3.33325 18.3337H14.9999C15.9204 18.3337 16.6666 17.5875 16.6666 16.667V5.83366L12.4999 1.66699H4.99992C4.07944 1.66699 3.33325 2.41318 3.33325 3.33366V6.66699" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M11.6667 1.66699V5.00033C11.6667 5.9208 12.4129 6.66699 13.3334 6.66699H16.6667M4.16675 10.0003L1.66675 12.5003L4.16675 15.0003M7.50008 15.0003L10.0001 12.5003L7.50008 10.0003" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      case "block":
        return (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M17.5 6.66626C17.4994 6.07143 17.1818 5.52201 16.6667 5.22459L10.8333 1.89126C10.3177 1.59354 9.68233 1.59354 9.16667 1.89126L3.33333 5.22459C2.81819 5.52201 2.50061 6.07143 2.5 6.66626V13.3329C2.50061 13.9278 2.81819 14.4772 3.33333 14.7746L9.16667 18.1079C9.68233 18.4056 10.3177 18.4056 10.8333 18.1079L16.6667 14.7746C17.1818 14.4772 17.4994 13.9278 17.5 13.3329V6.66626" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
            <path d="M2.75 5.83301L10 9.99967L17.25 5.83301M10 18.333V9.99967" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
          </svg>
        );
      default:
        return null;
  ...
  return (
    <div className="flex flex-col gap-6 p-6 rounded-lg border border-black/[0.08] bg-[#0B1518] shadow-[0_4px_20px_0_rgba(0,0,0,0.15)]">
      ...
      {/* Timeline */}
      <div className="relative overflow-x-auto min-h-[140px]">
        {isLoading ? (
          <div className="flex items-center justify-center h-20 text-[#98A6A8]">Chargement...</div>
        ) : (
